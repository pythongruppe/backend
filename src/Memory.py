...
key_part1 = "street"
key_part2 = "zip"
header = ["street", "rooms", "area_estate", "area_property", "monthly_payment", "cash_price", "zip", "city",
          "sq_meter_price", "property_type", "down_payment"]
...
def input_to_database(input):
    ...
    has_entity = exists_in_database(df, key)

    if has_entity:
        return "street+zipcode already exists in database"
